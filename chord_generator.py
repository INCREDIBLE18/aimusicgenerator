...
from music21 import stream, note, chord, duration, tempo, meter, key
...
def generate_chord_progression_song(progression_input, length=250, creativity=1.0, tempo_bpm=120, output_file="chord_song.mid"):
    ...
    Args:
        progression_input: Chord names, progression name, or roman numerals
        length: Number of tokens to generate
        creativity: Temperature for randomness
